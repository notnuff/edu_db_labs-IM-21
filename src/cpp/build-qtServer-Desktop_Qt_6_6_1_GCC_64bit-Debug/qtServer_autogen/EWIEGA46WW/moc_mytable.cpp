...
static constexpr auto qt_meta_stringdata_CLASSMyTableENDCLASS = QtMocHelpers::stringData(
    "MyTable"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSMyTableENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSMyTableENDCLASS_t qt_meta_stringdata_CLASSMyTableENDCLASS = {
    {
        QT_MOC_LITERAL(0, 7)   // "MyTable"
    },
    "MyTable"
};
